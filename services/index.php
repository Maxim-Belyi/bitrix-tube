...
<section id="pricing" class="pricing-area bg-color pt-60 pb-60">
    <div class="container">
        ...
        <?$APPLICATION->IncludeComponent("bitrix:news.list", "services_cards", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="single-pricing text-center mb-30">
                    ...
                    <div class="get-started">
                        <a href="../../../../bitrix/urlrewrite.php" class="btn">Узнать больше</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="single-pricing text-center mb-30">
                    ...
                    <div class="get-started">
                        <a href="../../../../bitrix/urlrewrite.php" class="btn premium-bg">Узнать больше</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
