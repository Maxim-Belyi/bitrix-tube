...
<xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?= LANGUAGE_ID ?>" lang="ru">
    ...
    <head>
        ...
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/assets/js/jquery.jquery.meanmenu.js");
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/assets/js/jquery.jquery.nav.js");
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/assets/js/jquery.jquery.parallax-1.1.3.js");
