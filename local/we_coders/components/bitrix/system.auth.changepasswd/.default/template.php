...
<div class="field">
	...
	<p style="clear: left;"><input type="hidden" name="captcha_sid" value="<? $arResult["CAPTCHA_CODE"]?>" /><img src="/bitrix/tools/captcha.php?captcha_sid=<?echo $arResult[" width="180" height="40" alt="CAPTCHA" /></p>
</div>
<?endif;?>
