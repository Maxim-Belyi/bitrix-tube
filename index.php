    ...
    <section class="slider-area">
        <div class="slider-active">
            <div class="single-slider">
                <div class="slider-img parallax-bg bg-opacity-black-60" style="background:url(<?= SITE_TEMPLATE_PATH ?>/assets/img/home_slider/home_slider1.jpg)"></div>
            ...
            <div class="single-slider">
                <div class="slider-img parallax-bg bg-opacity-black-60" style="background:url(<?= SITE_TEMPLATE_PATH ?>/assets/img/home_slider/home_slider2.jpg)"></div>
                <div class="slider-content slider-style-2 slider-style-4 text-center z-index-5">
            ...
            <div class="single-slider">
                <div class="slider-img parallax-bg bg-opacity-black-60" style="background:url(<?= SITE_TEMPLATE_PATH ?>/assets/img/home_slider/home_slider3.jpg)"></div>
                <div class="slider-content slider-style-2 slider-style-4 text-center z-index-5">
            ...
            <div class="row">
                ...
                <div id="Container">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mb-30 mix landing">
                        <div class="portfolio-wrapper portfolio-title">
                            <div class="<?= SITE_TEMPLATE_PATH ?>/assets/portfolio-img">
...
<p></p><?php require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>