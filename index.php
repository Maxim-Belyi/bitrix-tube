	...
	<div class="container">
		<h2 class="title-1">
			<? $APPLICATION->IncludeComponent(
				...
				array(
					"AREA_FILE_SHOW" => "file",
					"PATH" => SITE_TEMPLATE_PATH . "/includes/index/index_title.php"
				)
			); ?>
		</h2>
		<div class="row">
			<div class="col-md-7">
				<div class="who-we">
					<? $APPLICATION->IncludeComponent(
						...
						array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => SITE_TEMPLATE_PATH . "/includes/index/index_subtitle.php"
						)
					); ?>
				</div>
			</div>
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"PAGER_SHOW_ALL" => "N",	// Показывать ссылку "Все"
		"PAGER_SHOW_ALWAYS" => "N",	// Выводить всегда
		"PAGER_TEMPLATE" => "grid",	// Шаблон постраничной навигации
		"PAGER_TITLE" => "Новости",	// Название категорий
		"PREVIEW_TRUNCATE_LEN" => "",	// Максимальная длина анонса для вывода (только для типа текст)
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_TYPE" => "footer_slider",	// Тип информационного блока (используется только для проверки)
		"INCLUDE_IBLOCK_INTO_CHAIN" => "N",	// Включать инфоблок в цепочку навигации
